...
export const Experience = () => {
  return (
    <div id="experiencia">
      <h1 className="mt-20 flex justify-center pb-4 font-serif text-4xl font-semibold text-[#ffe4c4] underline">
        Experiencia laboral:
      </h1>
      ...
      <div className=" flex flex-wrap justify-center gap-4 pb-10 ">
        <div className="border-dark_grey hover:bg-hover flex min-h-[200px] flex-col rounded-lg border bg-black p-4 transition">
          ...
          <p className="tracking-sm mt-4 flex w-[300px] flex-row text-sm text-white">
            En mi tiempo como freelancer, mejore la comunicación abierta y la
            transparencia. Creo que establecer relaciones sólidas con mis
            clientes, comprendiendo sus necesidades me ayudo a mejorar mi
        ...
        <div className="border-dark_grey hover:bg-hover flex min-h-[200px] flex-col rounded-lg border bg-black p-4 transition">
          <span className="flex items-center gap-2">
            <h3 className="text-lg font-medium text-white">Fullstack @ DePC</h3>
          </span>
          <small className="flex gap-2 text-[.8rem] text-white">
            2022-2023
          </small>
